...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    global_proxy_source: config.global_proxy_source === "register_pool" ? "register_pool" : "custom",
...
type SettingsStore = {
  ...
  setGlobalProxySource: (value: GlobalProxySource) => void;
  ...
  setGlobalProxySource: (value) => {
    set((state) => {
      ...
      return {
        config: {
          ...state.config,
          global_proxy_source: value === "register_pool" ? "register_pool" : "custom",
        },
      };
    });
  },
